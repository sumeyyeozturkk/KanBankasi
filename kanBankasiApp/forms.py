...
class RegistrationForm(UserCreationForm):
	il_sec=Il.objects.all().values_list()
	#ilce_sec = Ilce.objects.all().values_list()
	...
	ilce = forms.ModelChoiceField(queryset=Ilce.objects.values_list('ilce_adi',flat = True).distinct())
